...
const INITIAL_POSTS: Post[] = [
  ...
  },
  {
    ...
    time: "25m",
    content:
      "In the process of building the FakeTwitwer project. React + TypeScript + Tailwind is on the go.",
  },
  {
    id: 3,
    author: "Cloud Coder",
  ...
  return (
    <>
      ...
      <main
        ...
        "
      >
        {/* LEFT COLUMN – all the selection/display stuff */}
        <aside className="hidden space-y-4 lg:block">
          ...
          {/* Who to follow (moved from right) */}
          ...
          {/* FakeTwitwer footer card (moved from right) */}
        ...
        {/* CENTER + RIGHT – feed spans two columns on large screens */}
        <section
          className="
